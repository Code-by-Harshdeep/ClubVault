 ...
 * Plain CSS (no Tailwind). Styles live in ClubVaultLanding.css,
 * icons come from lucide-react, copy/content in content.js.
 */
...
export default function ClubVaultLanding() {
  return (
    <div className="cv-root">
      ...
      <nav className="cv-nav">
        <div className="cv-nav-inner">
          <div className="cv-nav-left">
            <a className="cv-logo" href="#">ClubVault</a>
          ...
          <div className="cv-nav-right">
            <a href="/login" className="cv-link-login">Log In</a>
            <a href="/signup" className="cv-btn-nav-cta">Get Started</a>
        ...
        <div className="cv-container cv-hero-grid">
          <div className="cv-hero-copy">
            ...
            <div className="cv-hero-actions">
              <a href="#" className="cv-btn-primary">Start Your Vault</a>
              <button className="cv-btn-secondary">
                <CirclePlay size={16} /> Watch Demo
              </button>
            </div>
          </div>
          ...
          <div className="cv-hero-visual">
            ...
            <div className="cv-hero-imgwrap">
              <img
                ...
                alt="A modern laptop showing a minimal financial dashboard"
                src={mainImage}
              />
            </div>
        ...
        <div className="cv-container">
          <div className="cv-section-head">
            ...
            <p className="cv-section-sub">
              Tools built specifically for the unique needs of student organizations.
            </p>
          </div>
      ...
      <section className="cv-editorial">
        <div className="cv-container">
          <div className="cv-editorial-row">
            ...
            <div className="cv-editorial-copy">
              ...
              <ul className="cv-checklist">
                <li><CircleCheck className="cv-icon" size={20} /> Automated categorization</li>
                <li><CircleCheck className="cv-icon" size={20} /> Custom spending limits</li>
              </ul>
            </div>
          </div>
          ...
          <div className="cv-editorial-row">
            <div className="cv-editorial-copy second">
              ...
              <ul className="cv-checklist">
                <li><CircleCheck className="cv-icon" size={20} /> Multi-user access control</li>
                <li><CircleCheck className="cv-icon" size={20} /> Transparent audit logs</li>
              </ul>
            </div>
          ...
          <div className="cv-pricing-grid">
            {PLANS.map((plan) => (
              <div
                ...
                key={plan.name}
              >
                {plan.featured && <div className="cv-plan-badge">Most Popular</div>}
                ...
                <ul className="cv-plan-features">
                  {plan.features.map((f) => (
                    <li key={f}>
                      <CircleCheck size={16} /> {f}
                    </li>
                  ))}
                </ul>
                {plan.name === "Council" ? (
                  <button className="cv-btn-secondary" style={{ width: "100%" }}>
                    {plan.cta}
                  </button>
                ) : (
                  <a
                    href="#"
                    className={plan.featured ? "cv-btn-primary" : "cv-btn-secondary"}
      ...
      <footer className="cv-footer">
        <div className="cv-footer-inner">
          <div className="cv-footer-brand">
            ...
            <span className="cv-footer-copy">© 2026 ClubVault Finance. Built for Student Leaders.</span>
          </div>
